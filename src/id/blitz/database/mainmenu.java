...
public void bersih (){
    ...
    private void initComponents() {
        ...
        jButton3.setText("Form Pinjaman");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        double ha   = Double.parseDouble(jTextField2.getText());
        double ju   = Double.parseDouble(jTextField4.getText());
        ...
        //untuk tampilan saja dari diskon
        double dis2;
        if (total >= 250000)
        {
            dis2 = 10;
            jTextField3.setText(""+dis2);
        }
        if (total >= 400000)
        {
            dis2 = 20;
        ...
        //proses bayar
        double bayar = (total - dis);
        jTextField5.setText(""+bayar);
        
        try {
            String sql = "insert into tb_beli(barang,harga,jumlah,total,dis,bayar) values ('"+ba+"','"+ha+"','"+ju+"','"+total+"','"+dis+"','"+bayar+"')";
            lagi.state.executeUpdate(sql);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        pinjamanteman pindah = new pinjamanteman();
